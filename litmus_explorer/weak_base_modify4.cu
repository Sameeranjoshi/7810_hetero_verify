// Converted weak_base_modify2.cu 
// Added __managed__ way of allocating data.
...
// Different way of allocating managed memory.
__managed__ atomic<int> flag;
__managed__ int data[THREADS];
...
void run(Result *count_local){
    ...
    consumer<<<1,1024>>>(&flag, &data[0], result0, result1); 
